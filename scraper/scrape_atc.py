...
ALL THAT COFFEEWORKS(atcworks.base.shop、埼玉県さいたま市大宮区土手町、
自家焙煎スペシャルティコーヒー)の商品情報を取得する。BASE。
...
【非コーヒー豆商品の除外について】
実データ確認済み(全14件): 「MIZUDASHI COFFEE PACKS」(水出しコーヒー
...
SHOP_INFO = {
    "name": "ALL THAT COFFEEWORKS",
    "url": "https://atcworks.base.shop/",
    "platform": "BASE",
    "address": "埼玉県さいたま市大宮区土手町2-35",
    "prefecture": "埼玉県",
...
BASE_URL = "https://atcworks.base.shop"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        import json
        with open("data_atc.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"[done] {len(records)}件を data_atc.json に出力しました"
