...
杉綾珈琲豆店(sugiayacoffe.base.shop、東京都板橋区中板橋)の商品情報を
取得する。BASEの白ラベルドメイン「.base.shop」。情報サイト
(sugiayacoffeemameten.com、WordPress、注文機能無し)とは別にこちらが
実際のオンラインショップ。
...
【店頭受取版との重複について】
実データ確認済み(sitemap.xml上26件): 全13銘柄が「通常(宅配)」版と
...
SHOP_INFO = {
    "name": "杉綾珈琲豆店",
    "url": "https://sugiayacoffe.base.shop/",
    "platform": "BASE",
    "address": "東京都板橋区中板橋16-6",
    "prefecture": "東京都",
...
BASE_URL = "https://sugiayacoffe.base.shop"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        import json
        with open("data_sugiaya.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"[done] {len(records)}件を data_sugiaya.json に出力しました"
