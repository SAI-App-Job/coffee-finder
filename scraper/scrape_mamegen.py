...
珈琲焙煎工房 豆玄(shop.coffee-mamegen.com、長野県北佐久郡御代田町
馬瀬口460-7〈マメゲンコーヒー株式会社〉、自家焙煎豆のオンライン販売)の
商品情報を取得する。カラーミーショップ。
...
【非コーヒー豆商品の除外について】
実データ確認済み: 全29件のうちカフェ・オレ・ベース(加糖/カフェイン
レス/無糖)・豆玄オリジナルコーヒーバッグ(単品/カフェインレス)・
スペシャルティーアイスコーヒー(液体)・水出しアイスコーヒー(液体)・
...
SHOP_INFO = {
    "name": "珈琲焙煎工房 豆玄",
    "url": "https://shop.coffee-mamegen.com/",
    "platform": "カラーミーショップ",
    "address": "長野県北佐久郡御代田町馬瀬口460-7",
    "prefecture": "長野県",
...
BASE_URL = "https://shop.coffee-mamegen.com"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    with open("data_mamegen.json", "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    print(f"[done] {len(records)}件を data_mamegen.json に出力しました"
