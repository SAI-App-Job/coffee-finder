# -*- coding: utf-8 -*-
"""
scrape_katocoffee.py

加とう珈琲焙煎所(katocoffee.base.ec、東京都大田区大森北、2024年9月開業)の
商品情報を取得する。BASEの白ラベルドメイン「.base.ec」(BEANS珈琲・
MARUTAKE COFFEE BEANSの「.official.ec」等に続く同系列ドメイン)。
...
【非コーヒー豆商品の除外について】
実データ確認済み(全16件): 「アイスコーヒーバッグ　3個セット」「【ドリップ
バッグ】ご指定の豆＜5個入り＞」「【ドリップバッグ】お任せ詰め合わせ
...
SHOP_INFO = {
    "name": "加とう珈琲焙煎所",
    "url": "https://katocoffee.base.ec/",
    "platform": "BASE",
    "address": "東京都大田区大森北5-10-3",
    "prefecture": "東京都",
...
BASE_URL = "https://katocoffee.base.ec"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        with open("data_katocoffee.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"[done] {len(records)}件を data_katocoffee.json に出力しました"
