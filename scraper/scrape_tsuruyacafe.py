# -*- coding: utf-8 -*-
"""
scrape_tsuruyacafe.py

鶴屋(tsuruyacafe.thebase.in、大阪府東大阪市足代2-7-27、自家焙煎豆の
...
【非コーヒー豆商品の除外について】
実データ確認済み(全7件): 「コーヒー『味比べ』セット 全種」「コーヒー
『味比べ』3点セット」の2件が、複数銘柄の詰め合わせセット(単一銘柄の
豆単品ではない)のため非対象。NON_BEAN_KEYWORDSで除外する。残り5件が
豆単品(スペシャルミックス(ブレンド)・エメラルドマウンテン・ブラジル・
マンデリン・コロンビア、いずれも200gの単一サイズ)。

【flavor_notes(2026-09-21追記)】
実データ確認済み: og:descriptionに対象5件全てで甘み/酸味/苦味の★評価+
産地・グレード紹介文が入っている。注文/配送案内等の無関係な定型文の
混入は無いため全文をそのまま採用する。
"""
...
SHOP_INFO = {
    "name": "鶴屋",
    "url": "https://tsuruya-cafe.com/",
    "platform": "BASE",
    "address": "大阪府東大阪市足代2-7-27",
    "prefecture": "大阪府",
...
BASE_URL = "https://tsuruyacafe.thebase.in"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    with open("data_tsuruyacafe.json", "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    print(f"[done] {len(records)}件を data_tsuruyacafe.json に出力しました"
