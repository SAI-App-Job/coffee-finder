...
# 銘柄→産地対応表)
BEAN_INFO = {
    "【浅煎り】Huai Chompu": {"country": "タイ", "processing": "アナエロビック・ナチュラル", "category": "ストレート"},
    "【中煎り】Las Perlitas": {"country": "コロンビア", "processing": "ウォッシュド", "category": "ストレート"},
    "【中深煎り】Las Delicias": {"country": "ニカラグア", "processing": "ナチュラル", "category": "ストレート"},
    ...
    "DECAF (コクと甘み：中煎り)": {"country": "メキシコ", "decaf": True},
    "DECAF(華やか&フルーティ：浅煎り)": {"country": "エチオピア", "decaf": True},
}
