# -*- coding: utf-8 -*-
"""
scrape_nanoroaster.py

nano-coffeeroaster(nanoroaster.handcrafted.jp、東京都台東区浅草橋、
エチオピア専門の小規模焙煎所)の商品情報を取得する。BASEのカスタムドメイン
(handcrafted.jp、Tagurianoと同系列)。
...
【非コーヒー豆商品の除外について】
実データ確認済み(sitemap.xml上27件): ドリップパック商品(6種)、
はちみつ("COFFEE FOREST HONEY")、リキッドコーヒー("ゲイシャ100%濃縮
...
SHOP_INFO = {
    "name": "nano-coffeeroaster",
    "url": "https://nanoroaster.handcrafted.jp/",
    "platform": "BASE",
    "address": "東京都台東区浅草橋1-17-4",
    "prefecture": "東京都",
...
BASE_URL = "https://nanoroaster.handcrafted.jp"
CRAWL_DELAY_SECONDS = 1.5
REQUEST_HEADERS = {
    "User-Agent": "CoffeeFinderBot/0.1 (+contact: your-contact-info-here)"
}

NON_BEAN_KEYWORDS = ["ドリップパック", "はちみつ", "リキッド", "生豆", "セット"]
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        with open("data_nanoroaster.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"[done] {len(records)}件を data_nanoroaster.json に出力しました"
