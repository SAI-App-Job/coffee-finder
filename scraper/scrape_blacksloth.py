# -*- coding: utf-8 -*-
"""
scrape_blacksloth.py

BLACK SLOTH COFFEE(bscnet.base.shop、東京都足立区西新井、
自家焙煎エスプレッソスタンド)の商品情報を取得する。BASEの白ラベルドメイン
「.base.shop」。
...
【非コーヒー豆商品の除外について】
実データ確認済み(sitemap.xml上19件): 「初めてセット」(飲み比べセット)・
...
BASE_URL = "https://bscnet.base.shop"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        import json
        with open("data_blacksloth.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"[done] {len(records)}件を data_blacksloth.json に出力しました"
