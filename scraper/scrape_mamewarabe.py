# -*- coding: utf-8 -*-
"""
scrape_mamewarabe.py

手作り珈琲豆工房 豆わらべ(mamewarabe.theshop.jp、埼玉県深谷市上野台、
自家焙煎豆のオンライン販売、25年以上の老舗)の商品情報を取得する。
theshop.jp(BASE株式会社が運営する「THE SHOP」、BASE系列の別ブランド。
robots.txtの記述がBASE本体・official.ec・buyshop.jp等と同一の
「Generated by GRP」テンプレートであることを確認済みで、OGP方式が
そのまま流用できる)。
...
SHOP_INFO = {
    "name": "豆わらべ",
    "url": "https://mamewarabe.theshop.jp/",
    "platform": "THE SHOP(BASE系)",
    "address": "埼玉県深谷市上野台1949-3",
    "prefecture": "埼玉県",
...
BASE_URL = "https://mamewarabe.theshop.jp"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        import json
        with open("data_mamewarabe.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"[done] {len(records)}件を data_mamewarabe.json に出力しました"
