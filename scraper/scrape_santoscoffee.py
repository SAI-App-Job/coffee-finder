# -*- coding: utf-8 -*-
"""
scrape_santoscoffee.py

新潟みやげの珈琲 炭火自家焙煎珈琲SANTOS(santos-coffee.jp、新潟県新潟市
中央区天神1-17-6、自家焙煎豆のオンライン販売)の商品情報を取得する。
カラーミーショップ。
...
【非コーヒー豆商品の除外について】
実データ確認済み: 全21件のうち松/竹/梅の詰め合わせ(複数袋セット、
商品名に「○袋」を含む)・金/銀/銅(ドリップパック個数入り)・
...
SHOP_INFO = {
    "name": "SANTOS",
    "url": "https://santos-coffee.jp/",
    "platform": "カラーミーショップ",
    "address": "新潟県新潟市中央区天神1-17-6",
    "prefecture": "新潟県",
...
BASE_URL = "https://santos-coffee.jp"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    with open("data_santoscoffee.json", "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    print(f"[done] {len(records)}件を data_santoscoffee.json に出力しました"
