# -*- coding: utf-8 -*-
"""
scrape_javajivewest.py

Java Jive West(javajivewest.base.shop、大阪府茨木市舟木町11-36、自家焙煎豆の
...
【非コーヒー豆商品の除外について】
実データ確認済み(全8件): 全件がシングルオリジンの豆単品(200g、一部深煎り
表記あり)で、非対象商品(器具・ドリップバッグ・ギフト等)は無い。
NON_BEAN_KEYWORDSは念のため空リストではなく最小限の一般的な語のみ用意する。
...
SHOP_INFO = {
    "name": "Java Jive West",
    "url": "https://javajive-west.jp/",
    "platform": "BASE",
    "address": "大阪府茨木市舟木町11-36",
    "prefecture": "大阪府",
...
BASE_URL = "https://javajivewest.base.shop"
REQUEST_HEADERS = {
    "User-Agent": "CoffeeFinderBot/0.1 (+contact: your-contact-info-here)"
}

NON_BEAN_KEYWORDS = ["ドリップバッグ", "ギフト", "Tシャツ", "タンブラー"]
...
if __name__ == "__main__":
    ...
    with open("data_javajivewest.json", "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    print(f"[done] {len(records)}件を data_javajivewest.json に出力しました"
