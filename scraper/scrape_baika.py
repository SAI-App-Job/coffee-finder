...
Coffee Roast 焙香(ばいか、coffeebaika.base.shop、千葉県船橋市、
2023年10月開業のオンライン専業ロースター)の商品情報を取得する。
...
【非コーヒー豆商品の除外について】
実データ確認済み(sitemap.xml上62件): 複数銘柄・複数形態の詰め合わせ
(「セット」「飲み比べ」)、水出しアイスコーヒーバッグ、ドリップバッグ、
...
SHOP_INFO = {
    "name": "Coffee Roast 焙香",
    "url": "https://coffeebaika.base.shop/",
    "platform": "BASE",
    "address": "千葉県船橋市",
    "prefecture": "千葉県",
...
BASE_URL = "https://coffeebaika.base.shop"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        import json
        with open("data_baika.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"[done] {len(records)}件を data_baika.json に出力しました"
