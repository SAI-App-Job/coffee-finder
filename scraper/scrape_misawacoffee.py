# -*- coding: utf-8 -*-
"""
scrape_misawacoffee.py

三澤珈琲(misawacoffee.jp、長野県塩尻市金井263-1、自家焙煎豆(1983年
創業)のオンライン販売)の商品情報を取得する。カラーミーショップ。
...
【非コーヒー豆商品の除外について】
実データ確認済み: 全50件のうちカフェオレベース各種(加糖/無糖/ギフト)・
ドリップバッグ(単品/ギフト)・コーヒーギフトAset〜Dsetが非対象。
...
SHOP_INFO = {
    "name": "三澤珈琲",
    "url": "https://misawacoffee.jp/",
    "platform": "カラーミーショップ",
    "address": "長野県塩尻市金井263-1",
    "prefecture": "長野県",
...
BASE_URL = "https://misawacoffee.jp"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    with open("data_misawacoffee.json", "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    print(f"[done] {len(records)}件を data_misawacoffee.json に出力しました"
