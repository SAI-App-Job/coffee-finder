...
語洲燈(ゴスト、gostocoffee.shop-pro.jp、群馬県伊勢崎市三室町4105
〈運営: アイ・シー電子工業株式会社〉、自家焙煎豆のオンライン販売)の
商品情報を取得する。カラーミーショップ。
...
SHOP_INFO = {
    "name": "語洲燈",
    "url": "https://gostocoffee.shop-pro.jp/",
    "platform": "カラーミーショップ",
    "address": "群馬県伊勢崎市三室町4105",
    "prefecture": "群馬県",
...
BASE_URL = "https://gostocoffee.shop-pro.jp"
REQUEST_HEADERS = {
...
if __name__ == "__main__":
    ...
    with open("data_gosto.json", "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    print(f"[done] {len(records)}件を data_gosto.json に出力しました"
