# -*- coding: utf-8 -*-
"""
scrape_nasucoffee.py

那須珈琲 Cafe La Détente(nasu-coffee.com、栃木県那須郡那須町寺子丙3、
...
【非コーヒー豆商品の除外について】
実データ確認済み: 全24件のうちお試しセット(3種詰め合わせ)・ドリップ
バッグ4種セット(2回登録あり)・ハーブティードリップパック各種(ルイボス/
ビューティー/リフレッシュ/リラックス/デトックス、いずれも旧pid・新pid
の2系統で重複登録)・珈琲ギフトセット・珈琲＆ハーブティーギフトセット・
昔懐かし限定スペシャルドリップパック4種セットがコーヒー豆単品では
...
SHOP_INFO = {
    "name": "那須珈琲 Cafe La Détente",
    "url": "http://www.nasu-coffee.com/",
    "platform": "カラーミーショップ",
    "address": "栃木県那須郡那須町寺子丙3",
    "prefecture": "栃木県",
...
BASE_URL = "http://www.nasu-coffee.com"
REQUEST_HEADERS = {
    "User-Agent": "CoffeeFinderBot/0.1 (+contact: your-contact-info-here)"
}

NON_BEAN_KEYWORDS = [
    "お試しセット", "ドリップバッグ", "ハーブティー", "ギフトセット", "ドリップパック",
]
...
if __name__ == "__main__":
    ...
    with open("data_nasucoffee.json", "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)
    print(f"[done] {len(records)}件を data_nasucoffee.json に出力しました"
