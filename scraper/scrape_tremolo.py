...
実データ確認済み: og:descriptionに産地情報・テイスティング文・
焙煎度別の風味比較・スコア(★表示)が長文で入っており(対象17件全てで
確認)、末尾に店舗共通の「【焙煎度について】」以降の注文案内・
内容量の定型文が続く。「【焙煎度について】」の直前までを採用する。
"""
...
FLAVOR_STOP_PATTERN = re.compile(r"【焙煎度について】")
